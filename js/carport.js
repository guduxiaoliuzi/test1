...
function Carport(){
    ...
    $Yspeed.css({
        margin:"50px 0 0 30px","font-size":"25px",color:"white",
        "text-shadow":"#000 1px 0 0,#000 0 1px 0,#000 -1px 0 0,#000 0 -1px 0"
    });
    var $dspeed=$Yspeed.clone();
    $dspeed.css("margin-top","7px");
    ...
    $shop.css({
        ...
        background:"white",right:"2px","margin-top":"40px",'overflow': 'hidden',
    });
    var $stores=$("<div></div>");
    $stores.css({
        width:"523px",position:"absolute",top:"0px"
    });
